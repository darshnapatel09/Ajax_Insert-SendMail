...
if ($_SERVER['REQUEST_METHOD']=='POST') 
{
	   ...
	   if(isset($_FILES['file']))
    {
		...
		$qry="INSERT INTO registration(firstname,lastname,email,password,cpassword,address,gender,city,hobbies,files) values('".$firstname."','".$lastname."','".$email."','".$password."','".$cpassword."','".$address."','".$gender."','".$city."','".$hob."','".$root."')";
